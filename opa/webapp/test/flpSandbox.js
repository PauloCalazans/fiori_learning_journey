		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OPA Tests",
									"targetURL": "#studentcomsaptrainingadvancedsapui5opa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"studentcomsaptrainingadvancedsapui5opa-display": {
								"semanticObject": "studentcomsaptrainingadvancedsapui5opa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student.com.sap.training.advancedsapui5.opa",
									"url": sap.ui.require.toUrl("student/com/sap/training/advancedsapui5/opa")
								}
							}
						}
					}
